...
enum class PersonalityFramework {
    BigFive,
    OCEAN,
    MBTI,
    DISC,
...
struct PersonalityProfile {
    ...
    PersonalityFramework framework;
...
public:
    ...
    PersonalityProfile get_active_profile() const;
    std::vector<PersonalityProfile> get_available_human_profiles() const;
    std::string describe_active_personality() const;
    bool set_human_personality_profile(const std::string& profile_name);
    bool set_personality_framework(PersonalityFramework framework,
...
private:
    ...
    PersonalityProfile active_profile_;
    std::vector<PersonalityProfile> human_profiles_;
    std::vector<BehaviorPattern> behavior_patterns_;
    
    std::string apply_personality_filter(const std::string& text);
    void initialize_human_personality_profiles();
};
