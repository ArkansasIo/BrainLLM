...
void EnglishProcessor::initialize_dictionaries() {
    ...
    pos_dictionary_["a"] = PartOfSpeech::Determiner;
    pos_dictionary_["an"] = PartOfSpeech::Determiner;
    pos_dictionary_["is"] = PartOfSpeech::Verb;
    pos_dictionary_["are"] = PartOfSpeech::Verb;
    pos_dictionary_["was"] = PartOfSpeech::Verb;
    pos_dictionary_["were"] = PartOfSpeech::Verb;
    pos_dictionary_["run"] = PartOfSpeech::Verb;
    pos_dictionary_["process"] = PartOfSpeech::Verb;
    pos_dictionary_["generate"] = PartOfSpeech::Verb;
    pos_dictionary_["train"] = PartOfSpeech::Verb;
    pos_dictionary_["i"] = PartOfSpeech::Pronoun;
    pos_dictionary_["you"] = PartOfSpeech::Pronoun;
    pos_dictionary_["we"] = PartOfSpeech::Pronoun;
    pos_dictionary_["cat"] = PartOfSpeech::Noun;
    pos_dictionary_["brain"] = PartOfSpeech::Noun;
    pos_dictionary_["model"] = PartOfSpeech::Noun;
    pos_dictionary_["ai"] = PartOfSpeech::Noun;
    lemma_dictionary_["running"] = "run";
    lemma_dictionary_["walked"] = "walk";
    word_frequencies_["the"] = 0.95f;
    word_frequencies_["ai"] = 0.65f;
    word_frequencies_["model"] = 0.55f;
}
