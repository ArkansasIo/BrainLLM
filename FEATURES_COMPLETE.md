...
- **AIRLLM Bridge**: Optional vendored Python runtime for memory-optimized LLM inference
...
- **Memory Lattice**: Activated memory traces with emotional salience and ethical weighting
- **Cognitive Routing**: Conversation, analysis, deep search, ethical reflection, creative synthesis
- **Deep-Search Planning**: Plan, search, read, reflect, iterate, synthesize workflow
- **Evidence Scoring**: Relevance, authority, freshness, and safety scoring
- **Robotics-Law Review**: Rejects unsafe queries, private-data sources, and prompt-injection risk
...
- **Human Personality Frameworks**: Big Five/OCEAN, MBTI, DISC, Temperament, and Enneagram profile presets
...
#### 7.5 Data, Lua, and Audio Infrastructure
